    ...
    public partial class DatabaseSetup : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CdnFiles", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "JwtJwtRefreshTokens",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(150)", nullable: false),
                    Token = table.Column<string>(type: "nText", nullable: false),
                    ExpiresOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedByIp = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    RevokedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RevokedByIp = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    ReasonRevoked = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JwtJwtRefreshTokens", x => new { x.Id, x.UserId });
                    table.ForeignKey(
                        name: "FK_JwtJwtRefreshTokens_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QualificationName = table.Column<string>(type: "nvarchar(50)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Experience_Members_MemberId",
                        column: x => x.MemberId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JwtJwtRefreshTokens_ApplicationUserId",
