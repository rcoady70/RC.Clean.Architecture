...
namespace RC.CA.WebUi.ActionFilters;

/// <summary>
/// Enhanced logging. Log slow executing actions.
/// </summary>
...
public class EnhancedLogging : ActionFilterAttribute
{
    ...
    {
        _logger.LogDebug(LoggerEvents.DebugLifeCycle, $"Executing filter {nameof(EnhancedLogging)} Url {Microsoft.AspNetCore.Http.Extensions.UriHelper.GetDisplayUrl(context.HttpContext.Request)}");
