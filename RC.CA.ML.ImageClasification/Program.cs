...
using Microsoft.ML;
using RC.CA.ML.ImageClasification;
using System;
using System.IO;
using System.Linq;
...
var pipeline = context.Transforms.Conversion.MapValueToKey("LabelKey", "Label") //as no header reference by index. Labels are categorical
                                            //Load images image analytics nuget package. Input is the column name
...
{
    ImagePath = Path.Combine(Environment.CurrentDirectory, "images", "Bananna.jpg")
});
